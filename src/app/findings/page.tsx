...
export default async function FindingsPage() {
    const filePath = path.join(process.cwd(), "content", "findings.md")
        ...
        <div className="min-h-screen bg-slate-50">
            ...
            <main className="container py-8 md:py-12">
                <div className="mx-auto max-w-3xl rounded-xl border border-slate-200 bg-white p-6 shadow-sm md:p-12">
                    <article className="prose prose-slate max-w-none dark:prose-invert prose-headings:font-serif prose-headings:text-blue-900 prose-a:text-blue-600">
